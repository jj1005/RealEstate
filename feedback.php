...
{
    $sql3 = "UPDATE Request SET status = 'approved' WHERE (requestID = '" . $_POST["id"] . "')";
                ...
                <div class="single-property">
                    ...
                    <form action="" method="post">
                        <div class="desc">
                            ...
                            <input type="text" name="text" placeholder="Enter FeedBack" class=" container justify-content-center desc">
